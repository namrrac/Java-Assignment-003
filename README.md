...
1. Last add image markdown below this line to load your map image (Hint: Example image Markdown is just a couple lines above this).
    ![GPS Coordinates Screenshot](images/OttieTheOtter.PNG)
...
* Look at the getHiddenSecrets method and identify the following parts by editing this README.md and providing your answers:
    ...
    * Is it a **Class method** or an **object Instance method**, how do you know?
    ...
    ```It is a Static class method, because it is refered to the class name without creating an object.```
  ...
  * Scan line by line through the code and try to determine how it works?
  ...
  ```
    Only the import statments, the public class, 
    and the public static void, look familiar,
    everything else looks foreign and I would not
    have been able to solve this exercise without 
    the help of discord and chatGPT and google
    ```
